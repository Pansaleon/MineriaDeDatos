...
sns.scatterplot(x='Rating', y='Number of Reviews', hue='Cluster', data=data, palette='Set1', alpha=0.8, edgecolor='black', linewidth=0.5, s=80)
plt.xlabel('Rating', fontsize=14)
plt.ylabel('Number of Reviews', fontsize=14)
plt.title('Clustering de puntos en el gráfico de dispersión', fontsize=16, pad=100)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.grid(True)
plt.show()